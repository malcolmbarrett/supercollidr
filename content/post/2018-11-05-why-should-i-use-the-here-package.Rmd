...
But `here` has some added benefits: it makes it easier to manage subdirectories, and it makes your code more robust outside of projects. [As an example, I've set up an R project on my GitHub](https://github.com/malcolmbarrett/here_here) that has a file directory like this:
